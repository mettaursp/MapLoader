...
namespace Engine
{
	namespace Graphics
	{
		void PhongForwardPipeline::Configure()
		{
			...
			Graphics::ShaderBinding samplers{ vk::DescriptorType::eCombinedImageSampler, vk::ShaderStageFlagBits::eFragment, 1024, 1, 0, true };
			Graphics::ShaderBinding uniformBuffer2{ vk::DescriptorType::eUniformBuffer, vk::ShaderStageFlagBits::eFragment, 1, 2, 0 };
