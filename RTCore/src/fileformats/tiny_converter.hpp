...
private:
  ...
  private:
    vec3 m_min{std::numeric_limits<float>::max(), std::numeric_limits<float>::max(), std::numeric_limits<float>::max()};
    vec3 m_max{-std::numeric_limits<float>::max(), -std::numeric_limits<float>::max(),
