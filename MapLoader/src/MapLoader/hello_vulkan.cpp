...
void HelloVulkan::screenshot()
{
	...
	imageBarrier.srcAccessMask = VK_ACCESS_MEMORY_READ_BIT;//VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT;
	imageBarrier.dstAccessMask = VK_ACCESS_TRANSFER_READ_BIT;//VK_PIPELINE_STAGE_ALL_COMMANDS_BIT;
	imageBarrier.oldLayout = VK_IMAGE_LAYOUT_GENERAL;
	imageBarrier.newLayout = VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL;
	imageBarrier.image = m_offscreenColor.image;

	vkCmdPipelineBarrier(copyCmd, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_DEPENDENCY_VIEW_LOCAL_BIT_KHR, 0, nullptr, 0, nullptr, 1, &imageBarrier);
