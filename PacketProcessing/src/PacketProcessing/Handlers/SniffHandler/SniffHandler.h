...
namespace Networking
{
	namespace Packets
	{
		...
		template <>
		void SniffHandler::PacketParsed<Maple::Game::SpecialStat>(const Maple::Game::SpecialStat& packet);

		template <>
		void SniffHandler::PacketParsed<Client::ResponseVersionPacket>(const Client::ResponseVersionPacket& packet);

		template <>
		void SniffHandler::PacketParsed<Maple::Game::BonusStats>(const Maple::Game::BonusStats& packet);
		...
		template <>
		void SniffHandler::PacketParsed<Maple::Game::ItemBinding>(const Maple::Game::ItemBinding& packet);

		template <>
		void SniffHandler::PacketParsed<Server::FieldRemoveNpc>(const Server::FieldRemoveNpc& packet);

		template <>
		void SniffHandler::PacketParsed<Maple::Game::ItemCustomization>(const Maple::Game::ItemCustomization& packet);
