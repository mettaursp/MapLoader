...
void nvvkhl::AppBase::fitCamera(const vec3& boxMin, const vec3& boxMax, bool instantFit)
{
...
void nvvkhl::AppBase::updateCamera()
{
  ...
  for(auto key : m_keys)
  {
    ...
    {
      case GLFW_KEY_W:
        CameraManip.keyMotion(factor, 0, 0, nvh::CameraManipulator::Dolly);
        break;
      case GLFW_KEY_S:
        CameraManip.keyMotion(-factor, 0, 0, nvh::CameraManipulator::Dolly);
        break;
      case GLFW_KEY_A:
      case GLFW_KEY_LEFT:
        CameraManip.keyMotion(-factor, 0, 0, nvh::CameraManipulator::Pan);
        break;
      case GLFW_KEY_UP:
      ...
      case GLFW_KEY_RIGHT:
        ...
        break;
      case GLFW_KEY_E:
        CameraManip.keyMotion(0, 0, -factor, nvh::CameraManipulator::Pan);
        break;
      case GLFW_KEY_Q:
        CameraManip.keyMotion(0, 0, factor, nvh::CameraManipulator::Pan);
        break;
